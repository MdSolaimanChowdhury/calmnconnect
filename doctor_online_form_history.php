...
<body>
    ...
    $sql = "SELECT online_form_id, patient_gender, patient_age, patient_marry, patient_message, doctor_confirmation, created_at 
            FROM online_form 
        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="form-card">
                    ...
                    <a href="view_doctor_answered_online_form.php?form_id=<?php echo urlencode($row['online_form_id']); ?>">View Full Form</a>
                </div>
            <?php endwhile; ?>
        <?php else: ?>
            <p class="text-center">No History of Online Forms.</p>
        <?php endif; ?>
