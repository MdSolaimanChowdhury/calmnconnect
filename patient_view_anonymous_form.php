    ...
    <div class="container">
        <div class="form-container">
            ...
            if (isset($_GET['form_id'])) {
                ...
                $sql = "SELECT * FROM Anonymous_Form WHERE anonymous_form_id = ? AND patient_id = ?";
                $stmt = $conn->prepare($sql);
                $stmt->bind_param('ii', $form_id, $_SESSION['patient_id']);
                $stmt->execute();
                ...
                if ($form) {
                    ...
                    <div class="form-details">
                        ...
                        <p><span class="form-label">Your Message:</span> ' . nl2br(htmlspecialchars($form['patient_message'])) . '</p>
                        <p><span class="form-label">Answer of Psychologist:</span> ' . nl2br(htmlspecialchars($form['anonymous_solution'])) . '</p>
                    </div>';
                } else {
        ...
        <div class="back-btn">
            <a href="patient_anonymous_form_history.php">Back to Anonymous Forms History</a>
        </div>
    </div>
