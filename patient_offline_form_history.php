...
<body>
    ...
    $sql = "SELECT offline_form_id, patient_name, patient_mobile, patient_age, patient_marry, patient_message, doctor_confirmation, created_at 
            FROM offline_form 
            WHERE patient_id = ?
        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="form-card">
                    ...
                    <p><strong>Mobile no.:</strong> <?php echo htmlspecialchars($row['patient_mobile']); ?></p>
                    ...
                    <a href="patient_view_offline_form.php?form_id=<?php echo urlencode($row['offline_form_id']); ?>">View Full Form</a>
                </div>
            <?php endwhile; ?>
        <?php else: ?>
