...
<head>
    ...
    <title>Unread Offline Forms</title>
    <style>
        .form-card {
...
<body>
    ...
    $sql = "SELECT offline_form_id, patient_name, patient_gender, patient_age, patient_marry, patient_message, created_at 
            FROM offline_form 
    ...
    <div class="container">
        <h2 class="text-center my-4">Unread Offline Forms</h2>
        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="form-card">
                    ...
                    <a href="view_offline_form.php?form_id=<?php echo urlencode($row['offline_form_id']); ?>">View Full Form</a>
                </div>
            <?php endwhile; ?>
        <?php else: ?>
