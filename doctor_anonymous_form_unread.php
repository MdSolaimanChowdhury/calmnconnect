...
<head>
    ...
    <title>Unread Anonymous Forms</title>
    <style>
        .form-card {
...
<body>
    ...
    $sql = "SELECT anonymous_form_id, patient_gender, patient_age, patient_marry, patient_message, created_at 
            FROM Anonymous_Form 
    ...
    <div class="container">
        <h2 class="text-center my-4">Unread Anonymous Forms</h2>
        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="form-card">
                    ...
                    <a href="view_anonymous_form.php?form_id=<?php echo urlencode($row['anonymous_form_id']); ?>">View Full Form</a>
                </div>
            <?php endwhile; ?>
        <?php else: ?>
            <p class="text-center">No unread anonymous forms found.</p>
        <?php endif; ?>
