...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_solution']) && isset($_GET['form_id'])) {
    ...
    $update_sql = "UPDATE online_form SET doctor_confirmation = ? WHERE online_form_id = ? AND doctor_id = ?";
    ...
    if ($update_stmt->execute()) {
        ...
        header("Location: view_online_form.php?form_id=$form_id&solution_submitted=true");
        exit;
    } else {
...
if (isset($_GET['form_id'])) {
    ...
    $sql = "SELECT * FROM online_form WHERE online_form_id = ? AND doctor_id = ?";
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            ...
            if (isset($form)) {
                ...
                <div class="form-header">
                    <h3>Online Form ID: ' . htmlspecialchars($form['online_form_id']) . '</h3>
                </div>
        ...
        <div class="back-btn">
            <a href="doctor_online_form_unread.php">Back to Unread Forms</a>
        </div>
    </div>
