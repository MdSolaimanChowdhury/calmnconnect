...
<body>
    ...
    <div class="container">
            ...
            if (isset($_GET['form_id'])) {
                ...
                if ($form) {
                    ...
                    <div class="form-details">
                        ...
                        <p><span class="form-label">Solution:</span> ' . nl2br(htmlspecialchars($form['anonymous_solution'])) . '</p>
                    </div>';
                } else {
        ...
        <div class="back-btn">
            <a href="doctor_anonymous_form_history.php">Back to Anonymous Forms History</a>
        </div>
    </div>
